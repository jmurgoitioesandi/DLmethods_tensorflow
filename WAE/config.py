...
def cla():
    ...
    parser.add_argument('--dataname'   , type=str, required=True, help=textwrap.dedent('''Name of the file containing the dataset'''))
    parser.add_argument('--slide_num'   , type=str, required=True, help=textwrap.dedent('''Slide identification number'''))
    ...
    parser.add_argument('--lambda_param'     , type=float, default=1., help=textwrap.dedent('''Beta weight on the KL regularization of the loss function'''))
    parser.add_argument('--batch_size', type=int, default=16, help=textwrap.dedent('''Batch size while training'''))
    parser.add_argument('--learn_rate', type=float, default=1e-3, help=textwrap.dedent('''Initial Learning rate'''))
    parser.add_argument('--lr_sched', type=bool, default=True, help=textwrap.dedent('''Learning rate schedule'''))	
    parser.add_argument('--act_function', type=str, default='ReLU', help=textwrap.dedent('''Activation function name'''))
    parser.add_argument('--denseblock_n', type=int, default=3, help=textwrap.dedent('''Number of blocks in denseblock'''))
    ...
    parser.add_argument('--sample_plots' , type=int, default=5, help=textwrap.dedent('''Number of validation samples used to generate plots'''))
